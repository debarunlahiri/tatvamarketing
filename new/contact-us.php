                ...
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                    ...
                    <div class="mt-2 grid gap-1">
                        <?php foreach ($company['phones'] as $phone): ?>
                            <a href="tel:<?= e($phone['href']) ?>" class="font-semibold text-slate-800 transition hover:text-brand"><?= e($phone['label']) ?></a>
                        <?php endforeach; ?>
                    </div>
                    <p class="mt-2 text-sm text-slate-600"><?= e($company['hours']) ?></p>
                </div>
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
